...
class TamingFFHQVQVAE(BaseCodec):
    def __init__(
            ...
            trainable=False,
            token_shape=[16,16],
            config_path='OUTPUT/story2img_train/taming_dvae/vqgan_ffhq_f16_1024.yaml',
            ckpt_path='OUTPUT/story2img_train/taming_dvae/vqgan_ffhq_f16_1024.pth',
            num_tokens=1024,
            quantize_number=0,
            mapping_path=None,
        ):
...
class TamingVQVAE(BaseCodec):
    def __init__(
            ...
            trainable=False,
            token_shape=[16,16],
            config_path='OUTPUT/story2img_train/taming_dvae/vqgan_imagenet_f16_16384.yaml',
            ckpt_path='OUTPUT/story2img_train/taming_dvae/vqgan_imagenet_f16_16384.pth',
            num_tokens=16384,
            quantize_number=974,
...
class TamingGumbelVQVAE(BaseCodec):
    def __init__(
            ...
            trainable=False,
            token_shape=[32,32],
            config_path='OUTPUT/story2img_train/taming_dvae/taming_f8_8192_openimages.yaml',
            ckpt_path='OUTPUT/story2img_train/taming_dvae/taming_f8_8192_openimages_last.pth',
            num_tokens=8192,

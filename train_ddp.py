...
from image_synthesis.distributed.launch import launch_new
...
def get_args():
    ...
    parser.add_argument('--local_rank', type=int, default=NODE_RANK,
                        help='node rank for distributed training')
...
def main():
    ...
    launch_new(main_worker, args.ngpus_per_node, args.num_node, args.node_rank, args=(args,))
